...
set xlabel "Fully associative cache size (64 byte lines)" 0,.5 tc lt 0
set x2label ""
set timefmt "%d/%m/%y\n%H:%M"
set xrange [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set x2range [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel "Number of overflowing transactions" 5.5,0 tc lt 0
set y2label ""
...
set label "make" at graph .73, graph .94 right tc lt 8
set label "dbench" at graph .73, graph .86 right tc lt 8
