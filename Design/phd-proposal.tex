...
% $Id: phd-proposal.tex,v 1.12 2007-05-12 19:34:05 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
programming language.  Transactions can serve as an organizing
principle for concurrent and fault-tolerant programming, and be
...
\title{Efficient Software Transactions in Java}
...
exception-handling mechanism and to implement backtracking.
...
\cite{MansonPu01a,MansonPu01b} narrows the semantic gap, however I do not
...
with semantics given by the Java memory model \cite{MansonPu01a,MansonPu01b}.
...
oriented language to provide fault tolerance, backtracking, and
