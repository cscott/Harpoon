...
/**
 * A <code>Generic.Runtime</code> provides class data constructors which correspond
 * to a particular architecture/runtime combination.
 * 
 * @author  C. Scott Ananian <cananian@alumni.princeton.edu>
 * @version $Id: Runtime.java,v 1.1.2.3 1999-09-11 18:47:09 cananian Exp $
 */
public abstract class Runtime {
    /** Returns a <code>NameMap</code> valid for this <code>Generic.Runtime</code>. */
