 ...
 *     structures.
 * <LI>Static <Code>java.lang.reflect.Constructor</code> objects.  Similar
 *     to the above.
 * </OL>
 * 
 * @author  C. Scott Ananian <cananian@alumni.princeton.edu>
 * @version $Id: DataReflectionMemberList.java,v 1.7 2004-06-25 14:33:21 cananian Exp $
 */
	...
	for (Iterator it=ordered.iterator(); it.hasNext(); ) {
		...
		("java.lang.reflect." +
		 (hm instanceof HField ? "Field" :
		  isConstructor((HMethod)hm) ? "Constructor" : "Method"));
