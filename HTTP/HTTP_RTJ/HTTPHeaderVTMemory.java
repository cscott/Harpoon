...
public class HTTPHeaderVTMemory {

  // make a hashtable of return codes to messages
  static private HashStringsVTMemory rc = new HashStringsVTMemory();
  static
  {
    rc.put("200", "OK");
    rc.put("403", "Fobidden");
  ...
  static private HashStringsVTMemory ct = new HashStringsVTMemory();   // p. 817
  static
  {
