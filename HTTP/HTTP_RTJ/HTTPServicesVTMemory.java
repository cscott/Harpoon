...
//  	    }
	...
	if(resp.returnCode == 200)
	    HTTPHeaderVTMemory.send_header(out, resp.returnCode,
				   fileName, resp.sentBytes);
	else {
	    HTTPHeaderVTMemory.send_header(out, resp.returnCode, fileName, 0);
	    return null;
	}
