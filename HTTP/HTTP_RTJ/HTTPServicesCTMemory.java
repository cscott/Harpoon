...
//  	    }
    ...
    public static void GET_handler(String fileName, BufferedWriter out,
				   HTTPResponseCTMemory resp) {
    ...
    public static void POST_handler(String fileName, BufferedWriter out,
				    HTTPResponseCTMemory resp) {
	...
	if(resp.returnCode == 200)
	    HTTPHeaderCTMemory.send_header(out, resp.returnCode,
				   fileName, resp.sentBytes);
	else {
	    HTTPHeaderCTMemory.send_header(out, resp.returnCode, fileName, 0);
	    return null;
	}
