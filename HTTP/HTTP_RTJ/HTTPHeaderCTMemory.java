...
public class HTTPHeaderCTMemory {

  // make a hashtable of return codes to messages
  static private HashStringsCTMemory rc = new HashStringsCTMemory();
  static
  {
    rc.put("200", "OK");
    rc.put("403", "Fobidden");
  ...
  static private HashStringsCTMemory ct = new HashStringsCTMemory();   // p. 817
  static
  {
