...
% $Id: popl05.tex,v 1.2 2004-07-16 13:57:22 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
We implement this with a transaction around the traversal,
...
\note{Can we make this rigorous?}

\vspace*{5mm}
We have designed an implementation of software transactions which allows
