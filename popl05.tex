...
% $Id: popl05.tex,v 1.5 2004-07-16 16:24:56 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
We will first examine a destructive traversal algorithm, showing how a
...
Of course, we've chosen the simplest possible data structure here, but
...
Execution of a statement occurs only if it is enabled.  Most
...
functions beginning with {\tt move} are simple assignments; they've
been turned into macros so that reference counting allocated objects
can be performed.
