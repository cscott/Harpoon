...
% $Id: phd-thesis.tex,v 1.40 2007-04-08 01:49:48 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\usepackage{showidx}
%\draftcopyName{DRAFT $Revision: 1.40 $}{70}
...
%\chapter{An efficient software implementation of transactions}\label{sec:stm}
\input{phd-stm}
