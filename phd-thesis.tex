...
% $Id: phd-thesis.tex,v 1.47 2007-04-09 20:05:32 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\usepackage{showidx}
%\draftcopyName{DRAFT $Revision: 1.47 $}{70}
...
\newcommand{\subtitle}{Efficient Transactions in Software and Hardware}
