...
% $Id: phd-thesis.tex,v 1.38 2007-04-01 23:20:45 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\usepackage{epigraph}
\usepackage{makeidx}
\usepackage[pdfusetitle,pagebackref,colorlinks]{hyperref} % ooh, hyperlinks!
...
%\usepackage{showidx}
%\draftcopyName{DRAFT $Revision: 1.38 $}{70}
