...
% $Id: phd-thesis.tex,v 1.60 2007-05-26 20:52:44 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%% REMOVE DRAFTNOTICE FOR FINAL COPY %%%%%%%%%%%%%%%%%%%
%\documentclass[letterpaper,draftnotice]{phd-thesis}
\documentclass[letterpaper]{phd-thesis}
\newboolean{phdcolor}
\setboolean{phdcolor}{true} % set to false for b&w copy of thesis for archive
...
\usepackage[pdfusetitle,pagebackref,bookmarks,bookmarksnumbered,pdfpagelayout=TwoPageRight,breaklinks]{hyperref} % ooh, hyperlinks!
\ifthenelse{\boolean{phdcolor}}{\hypersetup{colorlinks}}{}
%\hypersetup{linktocpage} % useful when previewing with dvi
\usepackage{hypernat}
\usepackage{bold-extra}
%\makeindex % punting!
%\usepackage{showidx} % for draft only.
