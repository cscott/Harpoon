...
% $Id: phd-thesis.tex,v 1.37 2007-03-31 23:28:56 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass{phd-thesis}
\usepackage{hyperref} % make pretty hyperlinks in pdf output
\usepackage{verbatim}
\usepackage{alltt}
\usepackage{epigraph}
\usepackage{makeidx}
...
%\usepackage{showidx}
%\draftcopyName{DRAFT $Revision: 1.37 $}{70}
