...
% $Id: phd-thesis.tex,v 1.27 2006-09-27 19:46:57 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\usepackage{showidx}
%\draftcopyName{DRAFT $Revision: 1.27 $}{70}


\author{C. Scott Ananian}
\newcommand{\subtitle}{Efficient Useable Transactions in Software and Hardware}
\newcommand{\subdate}{September XX, 2006}
\title{\subtitle}
\date{\subdate \\ $ $Revision: 1.27 $ $}
