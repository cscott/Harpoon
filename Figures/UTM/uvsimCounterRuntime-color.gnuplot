...
set output 'uvsimCounterRuntime-color.emf'
set noclip points
set clip one
set noclip two
set bar 1.000000
...
set xlabel "Number of processors" 0,.5 textcolor lt 15
set timefmt "%d/%m/%y\n%H:%M"
set xrange [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel "Avg. cycles per iteration" 4 textcolor lt 15
...
set label "locks" at graph .23, graph .93 tc lt 13
set label "transactions" at graph .23, graph .85 tc lt 13
plot "uvsimCounterRuntime.txt" using 1:2 title " " with linespoints lw 4 ps 3, "uvsimCounterRuntime.txt" using 1:3 title " " with linespoints lw 4 ps 3
#    EOF
