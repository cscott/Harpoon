 ...
 * @version $Id: Temp.java,v 1.18 2004-02-08 01:59:47 cananian Exp $
...
public class Temp implements Cloneable, Comparable<Temp>, ReferenceUnique, java.io.Serializable {
  ...
  /** A <code>net.cscott.jutil.Indexer</code> specifically for working
      <b>only</b> with <code>Temp</code>s generated by
      <code>this.tempFactory()</code>. 
  */
  public static net.cscott.jutil.Indexer INDEXER = 
    new net.cscott.jutil.Indexer() {
  ...
  public Temp clone() { return clone(this.tf); }
