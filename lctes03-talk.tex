% CVSId: $Id: lctes03-talk.tex,v 1.21 2003-06-07 04:51:12 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TO DO:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
singleton set containing themselves, of course.  Notice that all
bitwidth tuples represent a range including zero, and, as we've
mentioned, the $m$ component summarizes the negative portions of the
range, and the $p$ component the positive.
~%
\end{talknotes}
...
function, but we'll define it explicitly.  The
...
represent the signed constant $c$.  @ To give more intuition,
for values in twos complement
...
in SSI form.
SSI is a variant of SSA form which @ allows us to distinguish
...
\FromSlide{2}
\begin{itemize}
\item Ignore the left-hand side of expression {\tt o.f}
...
\end{itemize}
\FromSlide{4}
\item All results in this work use zero-length context
