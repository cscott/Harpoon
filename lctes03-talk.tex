% CVSId: $Id: lctes03-talk.tex,v 1.14 2003-06-02 03:55:11 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TO DO:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%  - Try memory wall slide at start.
%  - Helvetica font on title slide
%  - Don't enumerate conclusions
...
\begin{itemize}
\item $\mathcal{C}:\mathbb{Z}$, incomparable integers
...
\end{itemize}
\item $\mathcal{L}:\left(\mathcal{C+T}\right)_\bot$, lattice values
\end{itemize}
\end{slide}
...
\tuple{0,0} & c=0 \\
\tuple{0,{\onlySlide{4}{\yellow}1+\left\lfloor\ln\left|c\right|\right\rfloor}} & c>0 \\
\tuple{{\onlySlide{5}{\yellow}1+\left\lfloor\ln\left|c\right|\right\rfloor},0} & c<0 \\
\end{cases}%
\end{displaymath}%
\FromSlide{3}%
\begin{displaymath}%
...
\item Analysis discovers:
\begin{itemize}
\item $e:\mathcal{E}\to\text{bool}$
\item $\func{val}:\mathcal{V}\to\mathcal{L}$
\end{itemize}
\end{itemize}
\end{slide}
...
\item $\mathcal{E}$, CFG edges
\item $\mathcal{V}$, (SSI form) variables
\item $\mathcal{F}$, fields in the program
\item Analysis discovers:
\begin{itemize}
\item $e:\mathcal{E}\to\text{bool}$
\item $\func{val}:(\mathcal{V}+\mathcal{F})\to\mathcal{L}$
\item $\func{Read}:2^\mathcal{F}$
\end{itemize}
\end{itemize}
\end{slide}
