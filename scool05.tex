...
% $Id: scool05.tex,v 1.14 2005-10-04 23:25:31 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{abstract}
% XXX FIX ME XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
object-based transaction system. We will present a mechanically-checked
...
object-based system which allows co-existence of non-transactional and
...
% LocalWords:  transactification Chuang
