...
% $Id: scool05.tex,v 1.24 2005-10-07 13:02:27 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
overhead (as shown in the figure).  The read barriers involved might
be another target for hardware support \cite{ClickTeWo05}; one could
also use small hardware transactions to implement the
Load-Linked/Store-Conditional atomic sequences.
