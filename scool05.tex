...
% $Id: scool05.tex,v 1.22 2005-10-06 22:22:46 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
than its own.  These steps can be combined and hoisted so that they
...
thread looks up the version object associated with its transaction
(this will typically be at the head of the version list) and reads the
...
to this field inside this transaction.
\begin{inlinecode}
