 ...
 * @version $Id: BasicBlock.java,v 1.1.2.35 2000-07-14 00:13:09 pnkfelix Exp $ */
public class BasicBlock implements java.io.Serializable {
	...
	*/
	...
	/** Generates an <code>Iterator</code> that traverses over all
	    ...
	    <code>BasicBlock.Factory</code> in Preorder.
	*/
	private Iterator preorderBlocksIter() {
	    return null;
	}
	
	/** Generates an <code>Iterator</code> that traverses over all
	    of the blocks generated by this
	    <code>BasicBlock.Factory</code> in Postorder.
	*/
	public Iterator postorderBlocksIter() {
	    ...
	    bbs.add(start);
	    iters.add(start.nextSet().iterator());
	    while(!bbs.isEmpty()) {
