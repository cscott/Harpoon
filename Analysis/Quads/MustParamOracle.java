 ...
 * @version $Id: MustParamOracle.java,v 1.3.2.1 2002-02-27 08:32:32 cananian Exp $
 */
public class MustParamOracle {
    ...
    public boolean isMustParam(Temp t) { return results.containsKey(t); }
	...
	for (int i=0; i<nparam; i++) {
		...
		assert old==null : "temp can't be multiple params!";
	    }
	    // and do next.
	}
	// done!
