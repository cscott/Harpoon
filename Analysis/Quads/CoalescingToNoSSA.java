 ...
 * @version $Id: CoalescingToNoSSA.java,v 1.3.2.1 2002-02-27 08:32:26 cananian Exp $
 */
public class CoalescingToNoSSA extends MethodMutator {
	...
	assert hc.getName().equals(QuadNoSSA.codename);
	...
	public void visit(SIGMA q) { assert false; }
