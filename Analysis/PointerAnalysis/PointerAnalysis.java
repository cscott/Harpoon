 ...
 * @version $Id: PointerAnalysis.java,v 1.18 2004-03-04 22:32:19 salcianu Exp $
 */
public class PointerAnalysis implements java.io.Serializable {
	...
	TopSortedCompDiGraph ts_mmethods = 
	...
	for(Object scc0 : scc_lbb_factory.computeSCCLBB(hm).decrOrder()) {
	    SCComponent scc = (SCComponent) scc0;
	    nb_sccs++;
	...
	TopSortedCompDiGraph ts_sccs = 
	    scc_lbb_factory.computeSCCLBB(mm.getHMethod());
	SCComponent scc = (SCComponent) ts_sccs.decrOrder().get(0);
	...
	for(Object scc0 : ts_sccs.decrOrder())
	    analyze_intra_proc_scc((SCComponent) scc0);
