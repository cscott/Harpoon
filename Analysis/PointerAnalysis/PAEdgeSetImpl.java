// PAEdgeSetImpl.java, created Sat Jan  8 23:37:30 2000 by salcianu
...
/**
 * <code>PAEdgeSetImpl</code> models the concept of a set of edges.
 ...
 * @version $Id: PAEdgeSetImpl.java,v 1.1.2.1 2000-07-01 23:15:59 salcianu Exp $
 */
public class PAEdgeSetImpl {
    ...
    public PAEdgeSetImpl specialize(final Map map) {
	final PAEdgeSetImpl es2 = new PAEdgeSetImpl();
    ...
    public void union(PAEdgeSetImpl edges2){
    ...
    /** Checks the equality of two <code>PAEdgeSetImpl</code>s. */
    public boolean equals(Object o){
	if(o==null) return false;
	PAEdgeSetImpl es2 = (PAEdgeSetImpl) o;
    ...
    public void copyEdges(PANode node, PAEdgeSetImpl es2){
    ...
    private PAEdgeSetImpl(Relation _var_edges, Hashtable _node_edges) {
	...
	return new PAEdgeSetImpl(new_var_edges, map_node_edges);
    }
