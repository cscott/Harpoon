 ...
 * @version $Id: SCCAnalysis.java,v 1.4 1998-09-23 04:17:10 cananian Exp $
 */
...
public class SCCAnalysis implements TypeMap, ConstMap, ExecMap {
	...
	SCCOpVisitor(HCode hc, Worklist Wv, Worklist Wq) {
	    this.hc = hc; this.Wv = Wv; this.Wq = Wq;
	}
