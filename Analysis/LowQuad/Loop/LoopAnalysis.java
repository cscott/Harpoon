 ...
 * @version $Id: LoopAnalysis.java,v 1.3.2.1 2002-02-27 08:31:34 cananian Exp $
 */
...
public class LoopAnalysis implements AllInductionsMap, BasicInductionsMap, InvariantsMap {
	...
	assert lp.loopEntrances().size()==1 : "Loop must have one entrance";
	...
	boolean lookat(OPER q) {
	    ...
	    int flag=-1;
	    POPER newpoper=null;
            Set loopIncElements = lp.loopIncElements();
	...
	public void visit(CJMP q)		{
	    ...
	    assert defs.length==1 : "We work only with SSA/SSI";
	    Temp binvar=null;
