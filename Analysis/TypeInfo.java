 ...
 * @version $Id: TypeInfo.java,v 1.10.2.1.2.1 1998-11-22 03:32:37 nkushman Exp $
 */
...
public class TypeInfo implements harpoon.Analysis.Maps.TypeMap {
	...
	HClass retval = (HClass) map.get(t);
	/*if (retval == null){
	    System.out.println ("Retval is null for temp: " + t.name());
	    System.out.println ("And this if for typeinfo: " + this.hashCode());
	...
	//System.out.println ("Actually analyzing the method.");
	...
	//System.out.println ("Calling merge which calls map.put");
