...
public class Realtime {
    ...
    public static boolean REALTIME_THREADS_PREEMPT = false;
	...
	if (opts.indexOf("threads")!=-1) {
	    ...
	    if (opts.indexOf("preempt")!=-1) {
		REALTIME_THREADS_PREEMPT = true;
		System.out.print("preempt");
	    } else {
		System.out.print("non-preempt");
	    }
	} else {
	    System.out.print("no");
	}
	...
	if (REALTIME_THREADS&&(!REALTIME_THREADS_PREEMPT)) {
