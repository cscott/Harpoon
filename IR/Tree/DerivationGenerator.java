 ...
 * @version $Id: DerivationGenerator.java,v 1.3.2.1 2002-02-27 08:36:47 cananian Exp $
 */
public class DerivationGenerator implements TreeDerivation {
	...
	assert exp!=null && type!=null;
	assert !dtM.containsKey(exp);
	...
	assert exp!=null && type!=null && temp!=null;
	assert !dtM.containsKey(exp);
	...
	assert exp!=null && derivation!=null;
	assert !dtM.containsKey(exp);
	...
	public void visit(Tree e) { assert false : ("Can't type: "+e); }
	...
	public void visit(MEM e) {
	    assert e.type() != Type.POINTER : "Can't determine type for MEM.";
	...
	public void visit(BINOP e) {
		...
		break;
	    default:
		assert false : ("Illegal pointer operation: "+e);
	    }
	}
	...
	public void visit(TEMP e) {
	    assert e.type != Type.POINTER : "Can't determine type for TEMP "+e+".";
	    this.tad = type2tad(e.type());
	}
    }
    // common types.
	...
	assert tad.type != null;
	assert tad.type == HClass.Void || !tad.type.isPrimitive();
	assert tad.temp != null : "Can't derive type if we don't know temp.";
