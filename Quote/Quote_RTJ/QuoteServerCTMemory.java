...
* @version 1.1 
*/ 
public class QuoteServerCTMemory { 
	...
	StockQuoteHandlerCTMemory newHandler = new 
 ...
 * a specific client. 
 */ 
class StockQuoteHandlerCTMemory implements Runnable { 
     ...
     */ 
    public StockQuoteHandlerCTMemory(Socket newSocket, 
				     String[] info) { 
	mySocket = newSocket; 
	stockInfo = info; 
    } 
