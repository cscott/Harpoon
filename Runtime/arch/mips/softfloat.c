...
void dwordToSingle( int64 *aPtr, bits32 *zPtr ) {
   *zPtr = int64_to_float32( *aPtr );
}

void dwordToDouble( int64* aPtr, int64 *zPtr ) {
   *zPtr = int64_to_float64( *aPtr );
}
void doubleToDWord( int64* aPtr, int64 *zPtr ) {
   *zPtr = float64_to_int64( *aPtr );
}
