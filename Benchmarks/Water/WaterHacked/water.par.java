...
class vec { 
  ...
  synchronized void crossProd(vec u, vec w) { 
    v0 = u.v1*w.v2 - u.v2*w.v1;
    v1 = u.v2*w.v0 - u.v0*w.v2;
    v2 = u.v0*w.v1 - u.v1*w.v0;
  }
...
class h2o {
  ...
  void storeDirVel(int dir, vec v){
    v.v0 = H1.getM(C.VEL).getElement(dir);
    v.v1 =  O.getM(C.VEL).getElement(dir);
    v.v2 = H2.getM(C.VEL).getElement(dir);
  }
  // ---------------------------------------------------------------------------
...
void INITIA()  throws java.io.FileNotFoundException, java.io.IOException {
  ...
  SU.setElement(0, new Double(s).doubleValue());

  SUM.clear();
  for(i = 0; i < numMol; i++) {
    for (k = 0; k < 3; k++) { 
      s = random_numbers.readLine();
      t.setElement(k, new Double(s).doubleValue());
    }
  ...
  SUM.v0 /= (C.NATOM*main.parms.getNMOL());
  SUM.v1 /= (C.NATOM*main.parms.getNMOL());
  SUM.v2 /= (C.NATOM*main.parms.getNMOL());
  ...
  for (i = 0; i < numMol; i++) {
    ...
    SU.v0 += (Math.pow((t.v0-SUM.v0),2.0) + Math.pow((t.v2-SUM.v0),2.0))/C.HMAS 
	+ Math.pow((t.v1-SUM.v0),2.0)/C.OMAS;
    molecule[i].storeDirVel(C.YDIR,t);
    SU.v1 += (Math.pow((t.v0-SUM.v1),2.0) + Math.pow((t.v2-SUM.v1),2.0))/C.HMAS 
	+ Math.pow((t.v1-SUM.v1),2.0)/C.OMAS;
    molecule[i].storeDirVel(C.ZDIR,t);
    SU.v2 += (Math.pow((t.v0-SUM.v2),2.0) + Math.pow((t.v2-SUM.v2),2.0))/C.HMAS 
	+ Math.pow((t.v1-SUM.v2),2.0)/C.OMAS;
  }
  FAC=main.parms.computeFAC();
  SU.v0=Math.sqrt(FAC/SU.v0);
  SU.v1=Math.sqrt(FAC/SU.v1);
  SU.v2=Math.sqrt(FAC/SU.v2);
...
*/
  ...
  if ((iter % main.parms.getNPRINT()) == 0){
    ...
    System.out.print(" ");
    System.out.print(loc_pot.v0);
    System.out.print(" ");
    System.out.print(loc_pot.v1);
    System.out.print(" ");
    System.out.print(loc_pot.v2);
    System.out.print(" ");
...
double interf2_aux(skratch_pad p1, skratch_pad p2, 
  ...
  /* CALCULATE X-COMPONENT FORCES */
    ...
    G23=GG[2]+GG[3];
    G45=GG[4]+GG[5];
    Res1[1].v0 = G110+GG[11]+GG[12]+C.C1*G23;
    Res2[1].v0 = -G110-GG[13]-GG[14]-C.C1*G45;
    TT1=GG[1]*C.C2;
    TT=G23*C.C2+TT1;
    Res1[0].v0 = GG[6]+GG[7]+GG[13]+TT+GG[4];
//    Res2[0][0] = GG[8]+GG[9]+GG[14]+TT+GG[5];
    Res1[2].v0 = GG[8]+GG[9]+GG[14]+TT+GG[5];
    TT=G45*C.C2+TT1;
//    Res1[2][0] = -GG[6]-GG[8]-GG[11]-TT-GG[2];
    Res2[0].v0 = -GG[6]-GG[8]-GG[11]-TT-GG[2];
    Res2[2].v0 = -GG[7]-GG[9]-GG[12]-TT-GG[3];
  ...
  /* CALCULATE Y-COMPONENT FORCES */
    ...
    G23=GG[2]+GG[3];
    G45=GG[4]+GG[5];
    Res1[1].v1 = G110+GG[11]+GG[12]+C.C1*G23;
    Res2[1].v1 = -G110-GG[13]-GG[14]-C.C1*G45;
    TT1=GG[1]*C.C2;
    TT=G23*C.C2+TT1;
    Res1[0].v1 = GG[6]+GG[7]+GG[13]+TT+GG[4];
//    Res2[0][1] = GG[8]+GG[9]+GG[14]+TT+GG[5];
    Res1[2].v1 = GG[8]+GG[9]+GG[14]+TT+GG[5];
    TT=G45*C.C2+TT1;
//    Res1[2][1] = -GG[6]-GG[8]-GG[11]-TT-GG[2];
    Res2[0].v1 = -GG[6]-GG[8]-GG[11]-TT-GG[2];
    Res2[2].v1 = -GG[7]-GG[9]-GG[12]-TT-GG[3];
  ...
  /* CALCULATE Z-COMPONENT FORCES */
    ...
    G23=GG[2]+GG[3];
    G45=GG[4]+GG[5];
    Res1[1].v2 = G110+GG[11]+GG[12]+C.C1*G23;
    Res2[1].v2 = -G110-GG[13]-GG[14]-C.C1*G45;
    TT1=GG[1]*C.C2;
    TT=G23*C.C2+TT1;
    Res1[0].v2 = GG[6]+GG[7]+GG[13]+TT+GG[4];
//    Res2[0][2] = GG[8]+GG[9]+GG[14]+TT+GG[5];
    Res1[2].v2 = GG[8]+GG[9]+GG[14]+TT+GG[5];
    TT=G45*C.C2+TT1;
//    Res1[2][2] = -GG[6]-GG[8]-GG[11]-TT-GG[2];
    Res2[0].v2 = -GG[6]-GG[8]-GG[11]-TT-GG[2];
    Res2[2].v2 = -GG[7]-GG[9]-GG[12]-TT-GG[3];
