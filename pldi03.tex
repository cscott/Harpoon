...
% $Id: pldi03.tex,v 1.6 2002-11-16 08:45:07 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% MISSING IDEAS:
%  pointer compression?
%  more discussion of multithreading semantics?
%  atomic update of 3-byte objects
%  hashtable picture?
%  more discussion of exectution time?
%  more back-patting on bitwidth analysis?  signed integers.
%  which fields got split/specialized?
%  make the case for constant field elimination *in the compiler*
%  talk about static elimination of hash/locks?
%  kava paper in related work?
