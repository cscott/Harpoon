...
% $Id: sas02.tex,v 1.3 2002-05-10 22:14:56 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{tabular}
\caption{(a) Portions of the {\tt java.lang.String} class.
         (b) Static specialization of {\tt java.lang.String}.}
\label{fig:string}
\end{figure}
...
\begin{figure}
\begin{center}
\renewcommand{\figscale}{0.6}\input{Figures/oopsla-lat}
\end{center}
