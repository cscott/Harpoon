...
% $Id: quads.tex,v 1.3 1998-09-08 14:32:44 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newcommand{\cls}[1]{\textrm{\textbf{#1}}}
\newcommand{\expn}[1]{\textrm{\textit{#1}}}
\begin{figure*}
\texttt{
package harpoon.IR.QuadSSA; \\
\\
\expn{Quadruple statements} \\
abstract class Quad implements harpoon.ClassFile.HCodeElement \\
