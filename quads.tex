...
% $Id: quads.tex,v 1.8 1998-09-09 13:31:27 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
its exception rethrown if that behaviour is desired.
%
...
\item[\cls{JMP}](HCodeElement source)
