 ...
 * @version $Id: HClassUtil.java,v 1.8.2.1 2002-02-27 08:37:46 cananian Exp $
 */
public abstract class HClassUtil  {
	...
	assert !a.isInterface() && !b.isInterface();
	assert !a.isArray() && !b.isArray();
	if (a.isPrimitive() || b.isPrimitive()) {
	    assert a==b : "Can't merge differing primitive types. "+
			"("+a+" and "+b+")";
	    return a;
	}
	...
	assert A[0]==B[0] : ("Hierarchy roots differ: "+A[0]+"/"+B[0]);
	int i;
	...
	assert a.getLinker()==b.getLinker();
