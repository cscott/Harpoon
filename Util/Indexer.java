 ...
 * @version $Id: Indexer.java,v 1.1.2.1 1999-11-09 06:28:27 pnkfelix Exp $
 */
interface Indexer {
	...
	<BR> <B>requires:</B> <code>o</code> is a member of the set of
   	     objects indexed by <code>this</code>.
	<BR> <B>effects:</B> returns the integer uniquely associated
