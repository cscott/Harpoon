 ...
 * @version $Id: LinearSet.java,v 1.2.2.1 2002-02-27 22:24:13 cananian Exp $
 */
public class LinearSet<E> extends AbstractSet<E> implements Cloneable,
	...
	backing store.
    */
    public LinearSet(final Set<E> set) {
    ...
    */
    public LinearSet(final ListFactory<E> lf, final Set<E> set) {
