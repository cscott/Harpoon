/* cheesy modification to make parametric polymorphism for hashtables */
 ...
 */
class Str2StrMapEntry {
    int hash;
    java.lang.String key;
    java.lang.String value;
    Str2StrMapEntry next;

//      protected Object clone() {
//  	Str2StrMapEntry entry = new Str2StrMapEntry();
//  	entry.hash = hash;
//  	entry.key = key;
//  	entry.value = value;
//  	entry.next = (next != null) ? (Str2StrMapEntry)next.clone() : null;
//  	return entry;
//      }
}
 ...
 */
public
class Str2StrMap implements Cloneable, java.io.Serializable {
    /**
     * The hash table data.
     */
    private transient Str2StrMapEntry table[];
     ...
     * @since      JDK1.0
     */
    public Str2StrMap(int initialCapacity, float loadFactor) {
	if ((initialCapacity <= 0) || (loadFactor <= 0.0)) {
	    throw new IllegalArgumentException();
	}
	this.loadFactor = loadFactor;
	table = new Str2StrMapEntry[initialCapacity];
     ...
     * @since   JDK1.0
     */
    public Str2StrMap(int initialCapacity) {
...
//      }
     ...
     * @since      JDK1.0
     */
    public synchronized boolean contains(java.lang.String value) {
	if (value == null) {
	    throw new NullPointerException();
	}

	Str2StrMapEntry tab[] = table;
	for (int i = tab.length ; i-- > 0 ;) {
	    for (Str2StrMapEntry e = tab[i] ; e != null ; e = e.next) {
	...
	for (Str2StrMapEntry e = tab[index] ; e != null ; e = e.next) {
     ...
     * @since   JDK1.0
     */
    public synchronized java.lang.String get(java.lang.String key) {
	Str2StrMapEntry tab[] = table;
	int hash = key.hashCode();
	int index = (hash & 0x7FFFFFFF) % tab.length;
	for (Str2StrMapEntry e = tab[index] ; e != null ; e = e.next) {
	...
	Str2StrMapEntry oldTable[] = table;

	int newCapacity = oldCapacity * 2 + 1;
	Str2StrMapEntry newTable[] = new Str2StrMapEntry[newCapacity];
	...
	for (int i = oldCapacity ; i-- > 0 ;) {
	    for (Str2StrMapEntry old = oldTable[i] ; old != null ; ) {
		Str2StrMapEntry e = old;
		old = old.next;
     ...
     * @since   JDK1.0
     */
    public synchronized java.lang.String put(java.lang.String key, java.lang.String value) {
	...
	Str2StrMapEntry e = new Str2StrMapEntry();
	e.hash = hash;
	e.key = key;
	e.value = value;
	e.next = tab[index];
     ...
     * @since   JDK1.0
     */
    public synchronized java.lang.String remove(java.lang.String key) {
	Str2StrMapEntry tab[] = table;
	int hash = key.hashCode();
	int index = (hash & 0x7FFFFFFF) % tab.length;
	for (Str2StrMapEntry e = tab[index], prev = null ; e != null ; prev = e, e = e.next) {
	    if ((e.hash == hash) && e.key.equals(key)) {
		if (prev != null) {
		    prev.next = e.next;
		} else {
