...
class ToyTreeVTMemory extends RealtimeThread {
	...
	ToyTreeVTMemory ta = new ToyTreeVTMemory(asize,repeats);
	ToyTreeVTMemory tb = new ToyTreeVTMemory(asize,repeats);
    ...
    int size;
    int repeat;
    public ToyTreeVTMemory(int size, int repeat) {
