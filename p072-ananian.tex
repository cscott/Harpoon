...
% $Id: p072-ananian.tex,v 1.1 2003-04-26 01:32:38 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% lctes03.tex
...
\category{D.3.4}{Program\-ming Languages}{Processors}[Optimization]
...
field externalization, field packing, bitwidth analysis}
%
...
\begin{tabular}{llrcrrr}
              &     &\bf always-zero&&\bf field bytes&\bf zero&\bf benchmark\\
\bf Benchmark &\bf Field &\bf bytes &&\bf dyn. alloc'd & \bf \% & \bf total
dyn. alloc'n\\
\hline
...
%mtrt       & Point.z & 4,106,728 &/& 17,846,808 & 23.0\% & 132MB\\
%           & Point.x & 3,296,476 &/& 17,846,808 & 18.5\% \\
jack       & String.offset & 7,442,956 &/& 7,443,276 & 100.0\% & 178MB\\
           & Hashtable\$Enumerator.type & 5,288,364 &/& 5,288,364 & 100.0\% \\
\end{tabular}
\caption{Representative ``mostly-zero'' fields found in SPEC benchmarks.}
...
% garbage collection; dynamic methods.  conservative gc.
...
\bibitem{ADGKRW99}
O.~Agesen, D.~Detlefs, A.~Garthwaite, R.~Knippel, Y.~Ramakrishna, and D.~White.
\newblock An efficient meta-lock for implementing ubiquitous synchronization.
\newblock In {\em Proceedings of the 14th Annual Conference on Object-Oriented
  Programming Systems, Languages and Applications}, pages 207--222, Denver,
  Colorado, November 1999.

\bibitem{aggarwal01}
Aneesh Aggarwal and Keith~H. Randall.
\newblock Related field analysis.
\newblock In {\em Proceedings of the {ACM} {SIGPLAN} '01 Conference on
  Programming Language Design and Implementation ({PLDI})}, pages 214--220,
  Snowbird, Utah, June 2001.

\bibitem{ACSE99}
J.~Aldrich, C.~Chambers, E.~Sirer, and S.~Eggers.
\newblock Static analyses for eliminating unnecessary synchronization from
  {J}ava programs.
\newblock In {\em Proceedings of the 6th International Static Analysis
  Symposium}, pages 19--38, September 1999.

\bibitem{ananian:siliconc}
C.~Scott Ananian.
\newblock Silicon {C}: A hardware backend for {SUIF}.
\newblock Available from \texttt{http://\hspace{0pt}flexc.lcs.mit.edu/%
  \hspace{0pt}SiliconC/\hspace{0pt}paper.pdf}, May 1998.

\bibitem{ananian99:tech}
C.~Scott Ananian.
\newblock The static single information form.
\newblock Technical Report MIT-LCS-TR-801, Massachusetts Institute of
  Technology, 1999.
\newblock Available from
  \texttt{http://\hspace{0pt}www.lcs.mit.edu/\hspace{0pt}publications/\hspace{%
0pt}pubs/\hspace{0pt}pdf/\hspace{0pt}MIT-LCS-TR-801.pdf}.

\bibitem{bacon02:efficient}
David~F. Bacon, Stephen~J. Fink, and David Grove.
\newblock Space- and time-efficient implementation of the {J}ava object model.
\newblock In B.~Magnusson, editor, {\em Proceedings of the 16th European
  Conference on Object-Oriented Programming}, volume 2374 of {\em Lecture Notes
  in Computer Science}, pages 111--132, M\'alaga, Spain, June 2002.

\bibitem{bacon98}
David~F. Bacon, Ravi Konuru, Chet Murthy, and Mauricio Serrano.
\newblock Thin locks: Featherweight synchronization for {J}ava.
\newblock In {\em Proceedings of the {ACM} {SIGPLAN} '98 Conference on
  Programming Language Design and Implementation ({PLDI})}, pages 258--268,
  Montreal, Canada, 1998.

\bibitem{bacon96}
David~F. Bacon and Peter~F. Sweeney.
\newblock Fast static analysis of {C++} virtual function calls.
\newblock In {\em Proceedings of the 11th Annual Conference on Object-Oriented
  Programming Systems, Languages and Applications}, pages 324--341, California,
  1996.

\bibitem{BH99}
Jeff Bogda and Urs H\"olzle.
\newblock Removing unnecessary synchronization in {J}ava.
\newblock In {\em Proceedings of the 14th Annual Conference on Object-Oriented
  Programming Systems, Languages and Applications}, pages 35--46, Denver,
  Colorado, November 1999.

\bibitem{BGSW00}
Mihai Budiu, Majd Sakr, Kip Walker, and Seth~Copen Goldstein.
\newblock {BitValue} inference: Detecting and exploiting narrow bitwidth
  computations.
\newblock In {\em Proceedings of the 2000 Europar Conference}, volume 1900 of
  {\em Lecture Notes in Computer Science}, Munich, Germany, August 2000.
  Springer Verlag.
...
\newblock In {\em Proceedings of the 14th Annual Conference on Object-Oriented
  Programming Systems, Languages and Applications}, pages 1--19, Denver,
  Colorado, November 1999.

\bibitem{DH99}
Sylvia Dieckmann and Urs H\"olzle.
\newblock A study of the allocation behavior of the {SPECjvm98} {J}ava
  benchmarks.
\newblock In {\em Proceedings of the 13th European Conference on
  Object-Oriented Programming}, August 1999.
...
\balancecolumns
  in a second.
\newblock In {\em Proceedings of the {ACM} {SIGPLAN} '01 Conference on
  Programming Language Design and Implementation ({PLDI})}, pages 254--263,
  Snowbird, Utah, June 2001.

\bibitem{marinov03}
Darko Marinov and Robert O'Callahan.
\newblock Object equality profiling.
\newblock Submitted to OOPSLA '03, 2003.

\bibitem{OK99}
Tamiya Onodera and Kiyokuni Kawachiya.
\newblock A study of locking objects with bimodal fields.
\newblock In {\em Proceedings of the 14th Annual Conference on Object-Oriented
  Programming Systems, Languages and Applications}, pages 223--237, Denver,
  Colorado, November 1999.

\bibitem{Ruf00:PLDI00}
Erik Ruf.
\newblock Effective synchronization removal for {J}ava.
\newblock In {\em Proceedings of the {ACM} {SIGPLAN} '00 Conference on
  Programming Language Design and Implementation ({PLDI})}, pages 208--218,
  Vancouver, Canada, June 2000.

\bibitem{RR00:PLDI00}
Radu Rugin\u{a} and Martin Rinard.
\newblock Symbolic bounds analysis of pointers, array indices, and accessed
  memory regions.
\newblock In {\em Proceedings of the {ACM} {SIGPLAN} '00 Conference on
  Programming Language Design and Implementation ({PLDI})}, pages 182--195,
  Vancouver, Canada, June 2000.

\bibitem{sreedhar00}
Vugranam~C. Sreedhar, Michael Burke, and Jong-Deok Choi.
\newblock A framework for interprocedural optimization in the presence of
  dynamic class loading.
\newblock In {\em Proceedings of the ACM SIGPLAN '00 conference on Programming
  language design and implementation}, pages 196--207. ACM Press, 2000.

\bibitem{stephenson00}
Mark Stephenson, Jonathan Babb, and Saman Amarasinghe.
\newblock Bitwidth analysis with application to silicon compilation.
\newblock In {\em Proceedings of the {ACM} {SIGPLAN} '00 Conference on
  Programming Language Design and Implementation ({PLDI})}, pages 108--120,
  Vancouver, Canada, June 2000.

\bibitem{salcianu01}
Alexandru S\u{a}lcianu and Martin Rinard.
\newblock Pointer and escape analysis for multithreaded programs.
\newblock In {\em Proceedings of the 8th {ACM} {SIGPLAN} symposium on
  Principles and Practice of Parallel Programming ({PPoPP})}, pages 12--23,
  Snowbird, Utah, June 2001.

\bibitem{SweeneyTip98DeadDataMembers}
Peter~F. Sweeney and Frank Tip.
\newblock A study of dead data members in {C}++ applications.
\newblock In {\em Proceedings of the {ACM} {SIGPLAN} '98 Conference on
  Programming Language Design and Implementation ({PLDI})}, pages 324--332,
  Montreal, Canada, 1998.

\bibitem{wegman91:scc}
...
\newblock In {\em Proceedings of the 14th Annual Conference on Object-Oriented
  Programming Systems, Languages and Applications}, pages 187--206, Denver,
  Colorado, November 1999.

\bibitem{zhang02}
Youtao Zhang and Rajiv Gupta.
\newblock Data compression transformations for dynamically allocated data
  structures.
\newblock In {\em International Conference on Compiler Construction}, volume
  2304 of {\em Lecture Notes in Computer Science}, pages 14--28, Grenoble,
