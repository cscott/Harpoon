...
% $Id: lctes03.tex,v 1.21 2003-04-25 23:36:00 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% lctes03.tex
...
\caption{Representative ``mostly-zero'' fields found in SPEC
           benchmarks.
%  Allocation numbers represent the number of
%           dynamically allocated bytes directly due to the specified
%           field.
}
