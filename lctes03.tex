...
% $Id: lctes03.tex,v 1.16 2003-04-25 19:40:30 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% lctes03.tex
...
optimizations. 
Although these techniques are applicable to any object-oriented
program, we expect they will be particularly applicable to
...
In this example all of the relevant fields are declared {\tt private},
enabling the analysis to determine all the required facts without
examining the rest of the program.  However, our analysis is powerful
