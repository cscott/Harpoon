...
% $Id: lctes03.tex,v 1.20 2003-04-25 22:35:11 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% lctes03.tex
...
%mtrt       & Point.z & 17,066k & 23.5\% \\
%           & Point.x & 17,123k & 18.8\% \\
...
\caption{Representative ``mostly-zero'' fields found in SPEC
           benchmarks.  Allocation numbers represent the number of
           dynamically allocated bytes directly due to the specified field.}
