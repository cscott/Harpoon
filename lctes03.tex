...
% $Id: lctes03.tex,v 1.18 2003-04-25 21:51:09 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% lctes03.tex
...
field sizes where possible.  This analysis extends our previous
intraprocedural analysis \cite{ananian99:tech} and is able
to derive all the dataflow facts found by
Wegman and Zadeck's Sparse Conditional Constant (SCC) propagation
algorithm \cite{wegman91:scc}, in addition to discovering properties
of Java objects and arrays and bitwidth information for integral types.
...
analysis encompasses SCC, we also identify constant variables and
...
\begin{tabular}{llrc}
              &          &\bf bytes & \\
              &          &\bf alloc'd & \\
\bf Benchmark &\bf field &\bf for field &\bf \% zero \\ \hline
compress   & Hashtable\$Entry.next & 3,552 & 49.7\% \\
           & String.offset & 3,180 & 90.9\% \\
jess       & jess.Token.negcnt & 7,573,616 & 100.0\% \\
           & jess.Value.floatval & 5,688,080 & 55.9\% \\
raytrace   & Point.z & 4,101,328 & 23.5\% \\
           & Point.x & 3,291,076 & 18.8\% \\
db         & String.offset & 508,204 & 99.9\% \\
           & Vector.capacityIncrement & 62,548 & 100.0\% \\
javac      & String.offset & 3,735,388 & 97.1\% \\
% missing one here
           & Statement.labels & 578,608 & 100.0\% \\
mpegaudio  & Hashtable\$Entry.next & 3,616 & 49.3\% \\
           & String.offset & 2,352 & 88.0\% \\
%mtrt       & Point.z & 4,106,728 & 23.5\% \\
%           & Point.x & 3,296,476 & 18.8\% \\
jack       & String.offset & 7,442,956 & 100.0\% \\
           & Hashtable\$Enumerator.type & 5,288,364 & 100.0\% \\
\end{tabular}
...
``mostly-zero'' fields in the SPEC benchmark identified by profiling
to help the reader gain some intuition about where such fields can be
found.
...
fail to identify constant members, which our analysis algorithm
