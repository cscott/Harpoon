...
% $Id: lctes03.tex,v 1.3 2003-02-08 01:49:48 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
externalization) may actually increase space usage. But 
as Table~\ref{tab:hashlock-opt} shows, 
...
\begin{table}[t]
\begin{tabular}{lcc}
\bf Benchmark &\bf \# classes & \bf \% alloc'ed space saved \\ \hline
%200\_check      & 253 &  3.8\% \\
201\_compress   & 216 &  0.0\% \\
202\_jess       & 379 &  6.0\% \\
205\_raytrace   & 239 & 14.4\% \\
209\_db         & 213 & 12.6\% \\
213\_javac      & 399 &  6.8\% \\
222\_mpegaudio  & 213 &  3.7\% \\
227\_mtrt       & 239 & 14.4\% \\
228\_jack       & 265 &  7.3\% \\
\end{tabular}
\caption{Number of classes statically referenced in SPEC benchmarks,
  ...
  compression using byte packing.}
...
\caption{Number of classes in SPEC benchmarks which dynamically use
  ...
  and the savings (in \% of total allocated bytes) of hash/lock
  externalization.}
...
typical Java program, and Table~\ref{tab:claz-space} shows that
all but two of the benchmarks in SPECjvm98
...
benchmark set is show in Table~\ref{tab:const-unused}.
...
% this figure looks better after the two tables.
\begin{figure}[tp]
\begin{eqnarray*}
-\tuple{m,p} &=& \tuple{p,m}\\
...
\centering
\begin{tabular}{llrc}
\bf Benchmark &\bf Field &\bf saved bytes &\bf \% zero \\ \hline
201\_compress   & Hashtable\$Entry.next & 3,552 & 49.7\% \\
                & String.offset & 3,180 & 90.9\% \\
202\_jess       & jess.Token.negcnt & 7,573,616 & 100.0\% \\
                & jess.Value.floatval & 5,688,080 & 55.9\% \\
205\_raytrace   & Point.z & 4,101,328 & 23.5\% \\
                & Point.x & 3,291,076 & 18.8\% \\
209\_db         & String.offset & 508,204 & 99.9\% \\
                & Vector.capacityIncrement & 62,548 & 100.0\% \\
213\_javac      & String.offset & 3,735,388 & 97.1\% \\
% missing one here
                & Statement.labels & 578,608 & 100.0\% \\
222\_mpegaudio  & Hashtable\$Entry.next & 3,616 & 49.3\% \\
                & String.offset & 2,352 & 88.0\% \\
227\_mtrt       & Point.z & 4,106,728 & 23.5\% \\
                & Point.x & 3,296,476 & 18.8\% \\
228\_jack       & String.offset & 7,442,956 & 100.0 \% \\
