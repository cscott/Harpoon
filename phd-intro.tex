...
of the two systems, obtaining the benefits of both.  I will also present
formal models of the implementation which have been mechanically
checked for correct behavior.

I will explore the implications on available, efficient, and usable
...
existing transactional mechanisms.  Compiler analyses
and type systems to further improve the efficiency, safety, and
usability of our transaction mechanisms will also be presented.
...
\subsection{Network flow}\label{sec:flow}
...
mentioned in \ref{sec:stringbuffer}, it
