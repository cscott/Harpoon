...
transactions which are efficient and powerful enough to be usable.
...
In \charef{largeobj} we consider one such limitation in depth,
...
I present an \defn{hybrid} transaction implementation,
...
\subsection{Backtracking}\label{sec:backtrack}
...
demonstrated in theory classes which are always prettily compiled to
...
% LocalWords:  unscalable dequeue enqueue composability filesystem
