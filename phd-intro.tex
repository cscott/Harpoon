...
In \charef{stm} I present the design of an efficient software-only
...
small compared to the transaction execution time.  I conclude by
...
\charef{stm}'s design.  I present details of the compiler
...
In \charef{largeobj} I consider one such limitation in depth,
...
In \charef{htm} I present hardware that enables very fast
