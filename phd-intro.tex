...
How can we program the coming generation of parallel systems?
...
a single synchronized processor from all of those resources.  It is
obvious that explicitly parallel systems are in our future.  
Techniques for effectively programming such systems are the subject of
this dissertation.
...
\section{The Rising Challenge of Multicore Programming}
