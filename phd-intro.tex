...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Examples of Transactional Programming}
\epigraphhead[70]{\epigraph{%
...
transactional context is discussed in \charef{io}.
...
condition to become true.  \Charef{object-wait} describes some
