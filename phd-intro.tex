...
cautionary note about the current limits of transactions.

In \charef{stm}, I will present an efficient software-only
...
built with transactions.  The challenge of integrating I/O within a
