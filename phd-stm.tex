...
\epsbigfigput[Transaction overhead for SPECjvm98.]{phd-spec-full}{%
  ...
  commit records at the start of each transaction, checks for abort
  after every call, but uses direct loads and stores for all accesses.
  The ``No arrays'' bar is similar, but only uses direct loads and
  stores for array accesses.
...
Benchmark & $t$ & $c_T$ \\ \hline
jess     &   408,416 &	1,006,376 \\
raytrace &       301 &	  133,686 \\
db       & 1,328,518 &	2,015,319 \\
javac    &        55 &	9,817,721 \\
mpegaudio&       287 &	    9,618 \\
jack     & 1,815,263 &	2,236,720 \\
\hline
\end{tabular}
\caption{Transaction and call rates for SPECjvm98 benchmarks.}
\label{fig:rates1}
\end{figure}
\begin{figure}\small
\begin{tabular}{l|rrrr}
Benchmark & $r_{NT}$ & $w_{NT}$ & $w_T$ & $w_T s_t$ \\ \hline
jess     &	26,700,326 &	4,054,334 &	16,873 &	22,651,942 \\
raytrace &	26,104,154 &	3,608,662 &	121,731 &	7,036,054 \\
db       &	18,187,254 &	987,484 &	361,431 &	14,534,338,856 \\
javac    &	15,091 &	 7,983 &	8,863,336 &	12,360,807,865 \\
mpegaudio&	212,850,162 &	38,663,921 &	   739 &	246,338 \\
jack     &	12,695,066 &	5,902,722 &	1,638,242 &	75,195,321 \\
\hline
\end{tabular}
\caption{Read and write rates for SPECjvm98 benchmarks.}
\label{fig:rates2}
\end{figure}
...
\item $w_T s_T$, the product of the transactional write rate with the
  ...
  0.23 ns overhead per byte in a object transactionally written.
