...
\epsbigfigput[Functional array performance on an array reversal microbenchmark.]{phd-arrayperf}{Functional array performance on an
  ...
  microseconds, required to do an array read followed by an update.
  The benchmark initialized the array and the reversed its contents
  100,000 times.  The reversal swapped the
...
implementation, described in \secref{naivefun}, ranged from 269 ns
