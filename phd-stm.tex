...
\ref{copythrough}) fields, and to perform the compare-and-swap
...
a discussion of operation complexity in \charef{large-obj}.}
...
Compare this to \figref{tr-multi-obj}; we've recast our earlier
transaction system design in terms of operations on an array datatype.
