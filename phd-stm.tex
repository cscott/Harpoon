...
example, \texttt{Get*Field}, \texttt{Get*ArrayElements}, or
\texttt{Set*Field}) the runtime checks the environment structure to
...
properly accounting for the wide range of data types in any real
programming language.  Java contains 8 primitive types, plus Object
types (which are themselves divided into array and non-array types).
