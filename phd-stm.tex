...
\section{Performance}
XXX: microbenchmark performance here
...
A. The Flex Compiler Infrastructure
   1. precisec backend (exception handling, etc)
B. Transforming Synchronization
   1. Analyses (check/field oracles)
   2. clone/arrayinit
   3. method splitting
C. Runtime impl
   1. Preproc specialization
   2. jni interface
D. Performance
   1. \# false conflicts
