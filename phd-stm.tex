...
In this chapter I will specifically describe the design of a
high-performance software transaction system.  I will first present
quantitative data on transaction properties, which will guide our
choices.  I will then describe the system goals and the design choices,
relying on additional quantitative data.  Then I will express an
implementation meeting those goals in the formal modeling language
Promela.  The correctness of this implementation can be model-checked
using the SPIN tool; the details of this effort are in
\appref{verification}.

In the next chapter I will discuss the practical implementation of
this design.
