...
\epsbigfigput[Nontransactional check overhead for SPECjvm98.]{phd-spec-nt}{%
  ...
  the write rate (stores performed divided by runtime) for each benchmark.}
...
instructions, as our protocol must do.
...
a very good predictor for check overhead.  The \texttt{mpegaudio}
...
\texttt{db} benchmarks have very similar read rates.  The
