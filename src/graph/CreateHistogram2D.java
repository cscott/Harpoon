...
/**
   ...
   on Gaussian derivatives. (See B. Schiele and J. L. Crowley, "Probabilistic Object Recognition using MultiDimensional Receptive Field Histograms)<br><br>
   ...
   <b>This class has not been fully implemented or tested and is not currently intended for use.</b>
...
public class CreateHistogram2D extends Node {
    ...
    */
    ...
    /**
       ...
       @param prefix The filename prefix for files that will be created by
       this object.
       @param axis1Min One of the axis characteristics for the histograms that will be created by this object.
       @param axis1Max One of the axis characteristics for the histograms that will be created by this object.
       @param axis1Buckets One of the axis characteristics for the histograms that will be created by this object.
       @param axis2Min One of the axis characteristics for the histograms that will be created by this object.
       @param axis2Max One of the axis characteristics for the histograms that will be created by this object.
       @param axis2Buckets One of the axis characteristics for the histograms that will be created by this object.
       @param out The {@link Node} to which processed images will be sent.
       @see Histogram2D
    */
    ...
    */
    ...
    /**
       ...
       @param newSigma The new sigma value that will be used to calculate gaussian derivatives.
    */
    ...
    */
    ...
    /**
       ...
       @param l The pixel location in the specified {@link ImageData} around which to center the convolution kernel.
