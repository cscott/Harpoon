// VTPhysicalMemory.java, created by Dumitru Daniliuc
...
public class VTPhysicalMemory extends ScopedMemory {
    ...
    /** Create an instance of <code>VTPhysicalMemory</code> with the given parameters.
     *
     *  @param type An instance of <code>Object</code> representing the type of memory
     *              required (e.g. <i>dma, shared</i>) - used to define the base
     *              address and control the mapping.
     *  @param size The size of the area in bytes.
     *  @throws java.lang.SecurityException The application doesn't have permission to
     ...
     *              address and control the mapping.
     *  @param base The physical memory address of the area.
     *  @param size A size estimator for shit memory area.
     *  @throws java.lang.SecurityException The application doesn't have permission to
     *                                      access physical memory or the given type
     *                                      of memory.
     *  @throws SizeOutOfBoundsException The size is negative or extends into an invalid
