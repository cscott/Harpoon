...
inline struct MemBlock* MemBlock_new(JNIEnv* env,
				     jobject memoryArea, jobject realtimeThread,
				     struct MemBlock* superBlock);
...
inline void* Scope_NoHeapRThread_MemBlock_alloc(struct MemBlock* mem, size_t size);
