...
% $Id: thesis.tex,v 1.21 1999-06-11 11:09:55 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{document}
\pagestyle{myheadings}\markboth{$ $Revision: 1.21 $ $}{$ $Revision: 1.21 $ $}
...
are mapped to $\bot_\domainsm{V}$. \textbf{FIXME: START CONDITION.}
\end{enumerate}
\end{definition}
