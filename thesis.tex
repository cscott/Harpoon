...
% $Id: thesis.tex,v 1.41 1999-06-14 05:42:55 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{document}
\pagestyle{myheadings}\markboth{$ $Revision: 1.41 $ $}{$ $Revision: 1.41 $ $}
...
\caption{Algorithm for placing \phisigfunction{s}.}
\label{fig:SSIalg}
\end{myfigure}
