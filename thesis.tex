...
% $Id: thesis.tex,v 1.55 1999-07-10 08:03:02 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\pagestyle{myheadings}\markboth{$ $Revision: 1.55 $ $}{$ $Revision: 1.55 $ $}
\pagenumbering{roman}
...
\begin{myfigure}\centering
\vertcenter{\renewcommand*{\figscale}{0.5}\input{Figures/THseseex}}\hspace{1cm}
