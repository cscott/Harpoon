...
% $Id: thesis.tex,v 1.26 1999-06-11 21:13:40 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{document}
\pagestyle{myheadings}\markboth{$ $Revision: 1.26 $ $}{$ $Revision: 1.26 $ $}
...
Figure \ref{fig:CQex} shows cycle-equivalent regions in a sample
control-flow graph.

\begin{myfigure}
\input{Figures/THcqex}
\caption{Control flow graph with SESE regions marked}
\label{fig:CQex}
\end{myfigure}
