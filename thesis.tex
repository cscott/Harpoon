...
% $Id: thesis.tex,v 1.9 1999-05-27 08:03:57 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
This paper, unfortunately, introduces yet another intermediate
representation to the literature.  This IR is the core of the FLEX
compiler project, which is investigating intelligent compilation
techniques for distributed systems, among other things.  This thesis,
in presenting this IR, attempts to keep both the mathematician and the
programmer in mind.  The Static Single Information form which is
presented has both a rigorous mathematical semantics and a factored
...
mathematical analysis of SSI form more tractable.  In particular, we
will mention here Java's stricter constraints on pointer variables.
...
meshing of practical implementation and mathematical elegance.

\section{Intermediate Representations}
The first paper directly addressing the intermediate representation of
a compiler was Foo and Bar in \cite{foobar}.  Recent work in this area
was touched off by the introduction of Static Single Assignment (SSA)
form by Shapiro and Saint in \cite{shapiro70:ssa}. Alpern, Rosen,
Wegman and Zadeck revived SSA form in a pair of POPL
...
\cite{chow96:hssa,chow97:ssapre}, academic research continues.
...
In comparison to these techniques, the domaniant characteristics of
...
has four different \phifunction{} variants ($\phi, \mu, \gamma, \eta$).
