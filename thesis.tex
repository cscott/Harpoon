...
% $Id: thesis.tex,v 1.91 1999-08-29 06:32:20 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\pagestyle{myheadings}\markboth{$ $Revision: 1.91 $ $}{$ $Revision: 1.91 $ $}
\pagenumbering{roman}
...
\caption{Environment datatype for the SSI renaming algorithm.}\label{fig:ssirend}
\end{myfigure}
\begin{myalgorithm}\small
\input{Figures/THssiren1}
\caption{SSI renaming algorithm.}\label{alg:ssiren1}
\end{myalgorithm}
\begin{myalgorithm}\small
\input{Figures/THssiren2}
\caption{SSI renaming algorithm, cont.}\label{alg:ssiren2}
\end{myalgorithm}
