...
% $Id: thesis.tex,v 1.108 1999-09-02 16:49:33 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\pagestyle{myheadings}\markboth{$ $Revision: 1.108 $ $}{$ $Revision: 1.108 $ $}
\pagenumbering{roman}
...
form.}
\footnote{Constant trigger is found via traversal of the SESE-region
tree. (First node post-dominated by a use of the constant?)}
