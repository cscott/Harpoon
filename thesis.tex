...
% $Id: thesis.tex,v 1.30 1999-06-12 19:01:26 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{document}
\pagestyle{myheadings}\markboth{$ $Revision: 1.30 $ $}{$ $Revision: 1.30 $ $}
...
\subsubsection{Single-Entry Single-Exit Regions and the Program Structure Tree}
...
% note that node f,g  and nodes c,d,e are 'sequentially composed'?
% does this matter?
