...
% $Id: thesis.tex,v 1.63 1999-08-17 16:39:21 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\pagestyle{myheadings}\markboth{$ $Revision: 1.63 $ $}{$ $Revision: 1.63 $ $}
\pagenumbering{roman}
...
\caption{Place \phisigfunction{s}.}\label{fig:SSIalg}
\end{myalgorithm}
...
\caption{SCC algorithm for SSA form, cont.}
\end{myalgorithm}
...
\newterm{uses} in the SSA representation of the program.
...
\fixme{Write up the SCC algorithm modifications necessary for SSI form.}
SSI form creates a new name for \code{bar} at the conditional branch
to indicate that more information about its value is known.  The utility
of this \newterm{predicated analysis} will become more evident as the SCC
value lattice is extended to cover more constant types.
\fixme{Time bounds for SCC/SSI.}
