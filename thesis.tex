...
% $Id: thesis.tex,v 1.50 1999-07-07 00:02:58 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{document}
\pagestyle{myheadings}\markboth{$ $Revision: 1.50 $ $}{$ $Revision: 1.50 $ $}
...
computation more than strictly necessary.  Figure \ref{fig:ctrldep},
...
inter-loop parallelism.\footnote{See for example \cite{traub86:ttdfa}
