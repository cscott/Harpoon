...
% $Id: thesis.tex,v 1.51 1999-07-08 00:58:03 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\usepackage{amsthm}
\usepackage{amstext}
\usepackage{varioref}\vrefwarning
% common definitions
\usepackage{comdef}

% number figures according to section
...
\begin{document}
\pagestyle{myheadings}\markboth{$ $Revision: 1.51 $ $}{$ $Revision: 1.51 $ $}
...
\mysection{Intermediate Representations}
...
inter-loop parallelism.\footnote{See for example \cite{traub86:ttda}
on tagged-token dataflow machines, and\ldots}% FORTRAN compilers?
\fixme{cite arvind's
...
\mysection{Static Single Information form}
