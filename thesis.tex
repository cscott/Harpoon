...
% $Id: thesis.tex,v 1.103 1999-09-01 18:29:10 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\pagestyle{myheadings}\markboth{$ $Revision: 1.103 $ $}{$ $Revision: 1.103 $ $}
\pagenumbering{roman}
...
simple extension of the integer constant portion of the lattice, with
...
FLEX java compiler platform. Some quantitative measure of the utility
