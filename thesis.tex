...
% $Id: thesis.tex,v 1.73 1999-08-21 05:54:01 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\pagestyle{myheadings}\markboth{$ $Revision: 1.73 $ $}{$ $Revision: 1.73 $ $}
\pagenumbering{roman}
...
\begin{myalgorithm}\small\linespread{0.75}\input{Figures/THsesealg}
