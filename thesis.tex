...
% $Id: thesis.tex,v 1.11 1999-05-28 01:45:28 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{document}
\pagestyle{myheadings}\markboth{$ $Revision: 1.11 $ $}{$ $Revision: 1.11 $ $}
...
\textbf{This is the \ssiplus{} portion of the paper.}

\subsection{Discussion}
\textbf{Why an executable representation is desirable.}

\subsection{Definition}
\textbf{\xifunction{s}.}

\subsection{Semantics}
\textbf{Presentation of operational semantics.}

\subsection{Construction algorithms}
\textbf{Presentation of algorithms; complexity analysis.}

\subsection{Uses and applications}
\textbf{Loop optimizations?  Hardware compilation.  Abstract evaluation.}
