...
% $Id: thesis.tex,v 1.102 1999-09-01 17:48:24 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\pagestyle{myheadings}\markboth{$ $Revision: 1.102 $ $}{$ $Revision: 1.102 $ $}
\pagenumbering{roman}
...
\cite{offner94}.  There is general agreement
...
Cytron \cite{cytron91} has shown that \phifunction{s} will always be
...
provides \cite{offner94}.  Because of \phifunction{} uses, the DFS
...
is always subsequently used before it is killed \cite{offner94}.
\end{definition}
\begin{definition}
...
\cite{offner94} and \cite{johnson93:dfg} for details on how to turn
...
utility of SPTC is given as table \vref{fig:sptc_numbers}.%
\fixme{These numbers are pretty poor.}
