...
% $Id: thesis.tex,v 1.59 1999-08-02 15:49:14 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\pagestyle{myheadings}\markboth{$ $Revision: 1.59 $ $}{$ $Revision: 1.59 $ $}
\pagenumbering{roman}
...
\ref{tab:chstats}\fixme{Get these stats from paper hidden somewhere on
desk.}  compares class hierarchy statistics for several large
