...
% $Id: thesis.tex,v 1.61 1999-08-03 19:35:54 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% useful stuff
\usepackage{algorithm} % algorithm environment, \listofalgorithms
...
\pagestyle{myheadings}\markboth{$ $Revision: 1.61 $ $}{$ $Revision: 1.61 $ $}
\pagenumbering{roman}
...
\caption{Algorithm for placing \phisigfunction{s}.}\label{fig:SSIalg}
\end{myfigure}
...
Java \code{double} type which has fewer than $2^{64}$ members.  The
