...
% $Id: thesis.tex,v 1.58 1999-08-01 10:11:32 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\pagestyle{myheadings}\markboth{$ $Revision: 1.58 $ $}{$ $Revision: 1.58 $ $}
\pagenumbering{roman}
...
\caption{Three-level lattice for SCC.}
\label{fig:scclat}
\end{myfigure}
The SCC algorithm works on a simple three-level lattice, shown in
figure \vref{fig:scclat}.
