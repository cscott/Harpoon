...
% $Id: thesis.tex,v 1.46 1999-06-21 05:04:30 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{document}
\pagestyle{myheadings}\markboth{$ $Revision: 1.46 $ $}{$ $Revision: 1.46 $ $}
...
property of the CFG, and \cite{pdw,appel:modern} suggest that accurate
knowledge of control-dependence relations is key to automatic
parallelization.   Many intermediate representations \cite{here} are
augmented with control-dependence edges to ensure proper execution.

Unfortunately, explicit control-flow edges tend to serialize
computation more than strictly necessary.\fixme{cite arvind's
compiler, and others.  Free your mind: delete control-dependence!}
...
\begin{myfigure}\centering
\vertcenter{\input{Figures/THseseex}}\hspace{1cm}
...
time, and is presented in figure~\ref{fig:SSIalg}.  No new node
...
us liveness straight from the stack state during translation, so we
