...
% $Id: thesis.tex,v 1.109 1999-09-02 18:19:44 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\pagestyle{myheadings}\markboth{$ $Revision: 1.109 $ $}{$ $Revision: 1.109 $ $}
\pagenumbering{roman}
...
\section{Conclusions}
SSI is wonderful.  You will all rejoice, hop, and skip merrily.  Yay.
