...
% $Id: thesis.tex,v 1.110 1999-09-02 19:34:33 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\pagestyle{myheadings}\markboth{$ $Revision: 1.110 $ $}{$ $Revision: 1.110 $ $}
\pagenumbering{roman}
...
$\mathcal{C}_T$ mapped to 0,\footnote{Any $k\succ\bot_\domainsm{V}$
...
these problems in the simplest and most symmetric manner.  The FLEX
compiler infrastructure demonstrates practically the real advantages
of SSI form.
