...
% $Id: thesis.tex,v 1.53 1999-07-08 22:11:44 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\pagestyle{myheadings}\markboth{$ $Revision: 1.53 $ $}{$ $Revision: 1.53 $ $}
\pagenumbering{roman}
...
\mysection{Static Single Information form}\label{sec:ssi}
