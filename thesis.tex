...
% $Id: thesis.tex,v 1.94 1999-08-30 16:17:24 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\pagestyle{myheadings}\markboth{$ $Revision: 1.94 $ $}{$ $Revision: 1.94 $ $}
\pagenumbering{roman}
...
to do fixup later, though.  I can draw a nice picture of a CFG where
this algorithm places more \phisigfunction{s} than strictly required.}
