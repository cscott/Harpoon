...
% $Id: thesis.tex,v 1.60 1999-08-03 05:01:35 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\pagestyle{myheadings}\markboth{$ $Revision: 1.60 $ $}{$ $Revision: 1.60 $ $}
\pagenumbering{roman}
...
\subsubsection{Predication using \sigfunction{s}.}
Foo.  Bar. Baz.
...
Java \code{float} type which has fewer than $2^{32}$ members.  The
...
\ref{tab:chstats}, using information from \cite{muthukrishnan96:ch},
...
550 classes with an average depth of 1.91; the deepest class was 5
...
Objectworks 4.1 & Smalltalk &   774   &    4.4     &    10      \\ \hline
\end{tabular}
\caption{Class hierarchy statistics for typical large O-O libraries.}
\label{tab:chstats}
\end{table}
