...
% $Id: thesis.tex,v 1.99 1999-08-31 18:07:02 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\pagestyle{myheadings}\markboth{$ $Revision: 1.99 $ $}{$ $Revision: 1.99 $ $}
\pagenumbering{roman}
...
\begin{myfigure}
\centering
\includegraphics[scale=0.4,angle=-90,clip=true]{Figures/THscccomp.eps}
