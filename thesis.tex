...
% $Id: thesis.tex,v 1.33 1999-06-12 21:34:52 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{document}
\pagestyle{myheadings}\markboth{$ $Revision: 1.33 $ $}{$ $Revision: 1.33 $ $}
...
Note that our algorithm for constructing SSI form is
