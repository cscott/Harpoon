...
% $Id: thesis.tex,v 1.28 1999-06-12 01:04:06 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{document}
\pagestyle{myheadings}\markboth{$ $Revision: 1.28 $ $}{$ $Revision: 1.28 $ $}
...
and edge properties used in the algorithm are described in figure
\ref{fig:CQdata}.  The interested reader is encouraged to consult
...
\newcommand{\cyceq}{\equiv}%{\equiv_{CYC}}
$\begin{array}[c]{cc}
...
\subsubsection{Single-Entry Single-Exit Regions}

\begin{myfigure}\small
\input{Figures/THsesedata}
\caption{Datatypes and operations used in the nested SESE algorithm.}
\label{fig:SESEdata}
\end{myfigure}

\begin{myfigure}\small\linespread{0.75}
\input{Figures/THsesealg}
\caption{Computing nested SESE regions.}
\label{fig:SESEalg}
\end{myfigure}

\begin{myfigure}
\centering\input{Figures/THseseex}
\caption{SESE regions for the control-flow graph of figure
         \ref{fig:CQex} (from \cite{johnson94:pst}).}
\label{fig:SESEex}
\end{myfigure}

\subsubsection{Program Structure Tree}
