...
% $Id: ecoop04.tex,v 1.2 2003-12-02 08:35:09 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
typical Java benchmarks.  A model for the software transaction
implementation is given in Promela, which has been mechanically
verified for correctness using the SPIN model checker.
We argue that our transaction mechanism
...
(locks), our algorithms will use non-blocking synchronization to
exploit optimistic concurrency.
...
\note{State the purpose of this paper.}
