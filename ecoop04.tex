...
% $Id: ecoop04.tex,v 1.7 2003-12-08 11:17:51 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
properties we observed in our benchmarks.
\punt{
We present modelling results affirming the correctness of the design, and compiler
...
There is a special flag value, which we call {\tt FLAG}.  It should be
...
We will present the other operations one-by-one, giving models in
Promela describing the algorithms involves.  The full Promela model is
available from the URL given at the end of the paper.
...
so long as the reader list remains empty.  If it is not empty, we
...
our version is still at the head of the versions list.  This addresses
