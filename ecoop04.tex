...
% $Id: ecoop04.tex,v 1.4 2003-12-02 10:46:31 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
correctness of the SPECjvm98 benchmarks we've examined.  Moreover, as
...
synchronized code which is transformed into transactions.
\punt{  Unlike the
...
\punt{Traces from the remaining SPECjvm98 applications were used to
...
of xops with at least a few large transactions.  
...
Further, if the synchronization in {\tt java.lang.StringBuffer} is
implemented with
...
% LocalWords:  Touitou Okasaki Qadeer Promela backoff transactified
