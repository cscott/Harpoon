% CVSId: $Id: oqe.tex,v 1.13 2002-05-08 22:07:20 cananian Exp $
\documentclass[%
pdf,
colorBG,
slideColor,
...
@ We solve this problem by \emph{virutalizing} the field: adding
...
%---------------------------------------------------------------------- SLIDE -
\overlays{2}{
\begin{slide}{Key properties (revisted)}
To use static specialization we need:
\begin{itemize}
 \item A field with a frequently-occuring value.
  \begin{itemize}\small
