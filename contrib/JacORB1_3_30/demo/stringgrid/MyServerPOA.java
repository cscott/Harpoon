...
public abstract class MyServerPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, demo.stringgrid.MyServerOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			catch(demo.stringgrid.MyServerPackage.MyException _ex0)
			{
				_out = handler.createExceptionReply();
				demo.stringgrid.MyServerPackage.MyExceptionHelper.write(_out, _ex0);
			}
				break;
			}
			case 2: // set
			{
				...
				java.lang.String _arg2=demo.stringgrid.MyServerPackage.fixedTHelper.read(_input);
				_out = handler.createReply();
			...
			case 3: // get
			{
				...
				short _arg1=_input.read_short();
				_out = handler.createReply();
				demo.stringgrid.MyServerPackage.fixedTHelper.write(_out,get(_arg0,_arg1));
				break;
			}
			case 4: // _get_width
			{
