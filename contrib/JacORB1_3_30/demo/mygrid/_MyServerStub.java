...
public class _MyServerStub
	...
	implements demo.mygrid.MyServer
{
	...
	public final static java.lang.Class _opsClass = demo.mygrid.MyServerOperations.class;
	public short height()
	{
		while(true)
		{
	...
	public short opWithException() throws demo.mygrid.MyServerPackage.MyException
	{
		...
		if(! this._is_local())
		{
			...
			{
				String _id = _ax.getId();
				if( _id.equals("IDL:demo/mygrid/MyServer/MyException:1.0"))
				{
					throw demo.mygrid.MyServerPackage.MyExceptionHelper.read(_ax.getInputStream());
				}
				else 
					throw new RuntimeException("Unexpected exception " + _id );
			}
	...
	public void set(short n, short m, java.math.BigDecimal value)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_os.write_short(n);
				_os.write_short(m);
				demo.mygrid.MyServerPackage.fixedTHelper.write(_os,value);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
	...
	public java.math.BigDecimal get(short n, short m)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_os.write_short(m);
				_is = _invoke(_os);
				java.math.BigDecimal _result = demo.mygrid.MyServerPackage.fixedTHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
