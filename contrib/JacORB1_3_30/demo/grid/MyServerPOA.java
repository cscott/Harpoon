...
public abstract class MyServerPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, demo.grid.MyServerOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			catch(demo.grid.MyServerPackage.MyException _ex0)
			{
				_out = handler.createExceptionReply();
				demo.grid.MyServerPackage.MyExceptionHelper.write(_out, _ex0);
			}
				break;
			}
			case 2: // set
			{
				...
				java.math.BigDecimal _arg2=demo.grid.MyServerPackage.fixedTHelper.read(_input);
				_out = handler.createReply();
			...
			case 3: // get
			{
				...
				short _arg1=_input.read_short();
				_out = handler.createReply();
				demo.grid.MyServerPackage.fixedTHelper.write(_out,get(_arg0,_arg1));
				break;
			}
			case 4: // _get_width
			{
