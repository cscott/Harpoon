...
{
	private static org.omg.CORBA.TypeCode _type = org.omg.CORBA.ORB.init().create_alias_tc( demo.grid.MyServerPackage.fixedTHelper.id(),"fixedT",org.omg.CORBA.ORB.init().create_fixed_tc((short)5,(short)2));
	public fixedTHelper ()
	{
	}
	...
	{
		return "IDL:demo/grid/MyServer/fixedT:1.0";
	}
	public static java.math.BigDecimal read(org.omg.CORBA.portable.InputStream _in)
	{
		java.math.BigDecimal _result;
				java.math.BigDecimal _fixed9004539=_in.read_fixed();
		_result = _fixed9004539.movePointLeft(2);
	...
	public static void write(org.omg.CORBA.portable.OutputStream _out, java.math.BigDecimal _s)
	{
		...
		java.math.BigDecimal _max9004539= new java.math.BigDecimal("1000");
		if( _s.compareTo(_max9004539 ) != -1)
