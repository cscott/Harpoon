...
% $Id: pldi04.tex,v 1.21 2003-11-12 06:22:21 cananian Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  An \texttt{atomic} declaration (or running under
our transactions implementation) would fix this programmer error.
[This bug was found by \cite{FlanaganQa03}.]
\note{What about just saying \texttt{public synchronized Append} ? -Bradley}
