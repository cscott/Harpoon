...
% $Id: ptran.tex,v 1.42 2002-08-01 04:04:41 cananian Exp $
...
\item $\func{c}_\text{from}:I\to 2^{V\times S}$ collects static values
...
\item $\func{c}_\text{to}:I\to 2^{V\times S}$ collects static values
...
{\tuple{\tuple{n_1,f},n_2}\in I \wedge
 \tuple{l_1,s}\in\func{c}_\text{from}(\tuple{\tuple{n_1,f},n_2}) \wedge
