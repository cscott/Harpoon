...
% $Id: ptran.tex,v 1.39 2002-07-31 21:47:35 cananian Exp $
...
%\func{unanalyzed}
%              (\tuple{O,I,\func{e},\func{c},r},n) =
% \func{unanalyzed}_\text{direct}(\tuple{O,I,\func{e},\func{c},r},n) \vee {}
%\\
% \exists n'\in N,f\in F : \left(\tuple{\tuple{n,f},n'}\in O\cup I
% \wedge
% \func{unanalyzed}
...
definite or possible companion.  Note that all remaining possible
companions will become definite companions after we are done
evaluating all the executable code in the program, as there will no
longer be any ``outside'' code left which could do naughty
companion-killing things. \textbf{XXX: unless we have unanalyzed methods!}
...
\textbf{What happens to possible companions?  They can now never
  become definite companions; do we continue to treat them as if
  they could?}
