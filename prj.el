...
(jde-set-variables 
 ...
 '(jde-gen-class-buffer-template (quote ("\"// \" (file-name-nondirectory buffer-file-name)" "\", created \" (current-time-string)" "\" by \" (user-login-name) 'n" "(funcall jde-gen-boilerplate-function)" "\"// Copyright (C) 1999 \" (user-full-name) \" <\" user-mail-address \">\" 'n" "\"// Licensed under the terms of the GNU GPL; see COPYING for details.\" 'n" "\"package harpoon.\" (harpoon-package-name \"Harpoon/Code/\") \";\" 'n 'n" "\"/**\" 'n" "\" * <code>\"" "(file-name-sans-extension (file-name-nondirectory buffer-file-name))" "\"</code>\" 'n" "\" * \" 'n" "\" * @author  \" (user-full-name)" "\" <\" user-mail-address \">\" 'n" "\" * @version $I\" \"d$\" 'n" "\" */\" 'n>" "\"public class \"" "(file-name-sans-extension (file-name-nondirectory buffer-file-name))" "\" \" (jde-gen-get-super-class) \" {\" 'n> 'n>" "\"/** Creates a <code>\" " "(file-name-sans-extension (file-name-nondirectory buffer-file-name))" "\"</code>. */\" 'n" "\"public \"" "(file-name-sans-extension (file-name-nondirectory buffer-file-name))" "\"() {\" 'n>" "\"    \" 'p 'n>" "\"}\" 'n>" "'n>" "\"}\"")) t)
 '(jde-compiler "javac")
