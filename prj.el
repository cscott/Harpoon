...
(jde-set-variables 
 ...
 '(jde-gen-class-buffer-template (quote ("\"// \" (file-name-nondirectory buffer-file-name)" "\", created \" (current-time-string)" "\" by \" (user-login-name) 'n" "(funcall jde-gen-boilerplate-function)" "\"package harpoon.\" (cananian-package-name \"Harpoon/Code/\") \";\" 'n" "'n" "\"import harpoon.ClassFile.*;\" 'n" "\"/**\" 'n" "\" * <code>\"" "(file-name-sans-extension (file-name-nondirectory buffer-file-name))" "\"</code>\" 'n" "\" * \" 'n" "\" * @author  \" (user-full-name)" "\" <\" (user-login-name) \"@alumni.princeton.edu>\" 'n" "\" * @version $Id: prj.el,v 1.1 1998-08-05 11:11:04 cananian Exp $\" 'n" "\" */\" 'n>" "'n>" "\"public class \"" "(file-name-sans-extension (file-name-nondirectory buffer-file-name))" "\" \" (jde-gen-get-super-class) \" {\" 'n> 'n>" "\"/** Creates a <code>\" " "(file-name-sans-extension (file-name-nondirectory buffer-file-name))" "\"</code>. */\" 'n" "\"public \"" "(file-name-sans-extension (file-name-nondirectory buffer-file-name))" "\"() {\" 'n>" "\"    \" 'p 'n>" "\"}\" 'n>" "'n>" "\"}\"")) t)
 '(jde-compiler "javac")
