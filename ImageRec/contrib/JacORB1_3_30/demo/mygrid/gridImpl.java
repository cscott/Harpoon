...
import demo.mygrid.MyServerPackage.MyException;
    ...
    extends MyServerPOA
{
    ...
    public short opWithException()
        throws demo.mygrid.MyServerPackage.MyException
    {
        throw new demo.mygrid.MyServerPackage.MyException("This is only a test exception, no harm done :-)");
    }
