...
public class _MyServerStub
	...
	implements demo.stringgrid.MyServer
{
	private String[] ids = {"IDL:demo/stringgrid/MyServer:1.0","IDL:omg.org/CORBA/Object:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = demo.stringgrid.MyServerOperations.class;
	public short height()
	{
		while(true)
		{
	...
	public short opWithException() throws demo.stringgrid.MyServerPackage.MyException
	{
		...
		if(! this._is_local())
		{
			...
			{
				String _id = _ax.getId();
				if( _id.equals("IDL:demo/stringgrid/MyServer/MyException:1.0"))
				{
					throw demo.stringgrid.MyServerPackage.MyExceptionHelper.read(_ax.getInputStream());
				}
				else 
					throw new RuntimeException("Unexpected exception " + _id );
			}
	...
	public void set(short n, short m, java.lang.String value)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_os.write_short(n);
				_os.write_short(m);
				demo.stringgrid.MyServerPackage.fixedTHelper.write(_os,value);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
	...
	public java.lang.String get(short n, short m)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_os.write_short(m);
				_is = _invoke(_os);
				java.lang.String _result = demo.stringgrid.MyServerPackage.fixedTHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
