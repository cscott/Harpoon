// IfNotThen.java, created by benster
 ...
 * is checked. If the value is <code>false</code>, then the {@link ImageData}
 * is sent along the right-hand path. If the value is <code>true</code>
...
*/
public class IfNotThen extends Node {
    /**
    ...
    /**
     * Constructs an {@link IfNotThen} node that
     * will send {@link ImageData}s along the right-hand
     * path conditional if the value of the
     * specified {@link CommonMemory} variable is <code>true</code> at
     * the time of execution.
     *
     * @see CommonMemory
     */
    public IfNotThen(String commonMemName) {
     ...
     * specified in the constructor is <code>false</code>.
     *
