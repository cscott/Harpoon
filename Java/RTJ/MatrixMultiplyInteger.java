...
public class MatrixMultiplyInteger {
    public static void main(String[] args) {
	Random r = new Random();

	Integer dim = new Integer(8);
	...
	for (Integer i = new Integer(0); i.intValue() < dim.intValue();
		...
		A[i.intValue()][j.intValue()] = new Integer(r.nextInt(9));
		B[i.intValue()][j.intValue()] = new Integer(r.nextInt(9));
